...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_AdcIsr_0;
...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GptIsr_0;

/*! ISR configuration data: IcuIsr_0 */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_IcuIsr_0;

/*! ISR configuration data: SpiIsrTx_1 */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SpiIsrTx_1;

/*! ISR configuration data: SpiIsrTx_2 */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SpiIsrTx_2;
